...
"C:\Program Files\Java\jdk1.6.0\bin\jar.exe" cmf _JarManifest.txt TotalByteInformer.jar *.class images org
"C:\Program Files\Java\jdk1.6.0\bin\jar.exe" cfM _release/tbi.zip _Readme_TotalByteInformer.txt *.jar *.ico TotalByteInformer.bat openFile.bat language logs settings temp updates *.exe
move TotalByteInformer.jar _release
